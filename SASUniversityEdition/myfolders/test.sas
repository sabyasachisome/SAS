...
proc import datafile = "/folders/myfolders/Data_201902/score_data_id_partial_score4" 
DBMS = xlsx out = scoredata_p replace ;
run;

proc import datafile = "/folders/myfolders/Data_201902/score_data_id" 
